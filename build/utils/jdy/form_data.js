...
class FormDataApiClient extends ApiClient {
     ...
     * 删除单条数据接口
     */
    async singleDataRemove(app_id, entry_id, data_id, is_start_trigger = false) {
        return await this.doRequest({
            method: "POST",
    ...
    async _batchDataQuery(app_id, entry_id, options) {
     ...
     * 修改多条数据接口
     */
    async batchDataUpdate(app_id, entry_id, data_ids, data, transactionId = "") {
        return await this.doRequest({
            method: "POST",
